...
import { IssueCategory, IssueSeverity, AiDetectionResult } from '../types';
...
export const ReportIssuePage: React.FC<ReportIssuePageProps> = ({ onIssueCreated, prefillData }) => {
  // Form state
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-xs space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Describe the condition, pedestrian obstruction, duration, or any visible hazards..."
